...
class ChatResponder
{
    ...
    public function category(Conversation $conv, string $userMessage): string
    {
        ...
        if (preg_match('/(打開|打开|開啟|开启|啟動|启动|傳訊息|传讯息|傳個訊息|傳.{1,10}(給|说|說)|发讯息|回覆|回复|回.{1,8}(說|说|訊息|消息)|播放|播.{0,6}歌|放.{0,4}(歌|音樂|音乐)|放歌|聽歌|听歌|导航|導航|帶我去|带我去|路線|路线|打電話|打电话|打給|打给|打去|代打|訂位|订位|撥號|拨号|截圖|截图|看.{0,4}畫面|看.{0,4}画面|操作|點擊|点击|搜尋|搜寻|查一下|查詢|查询|上網查|附近|寄信|寄.{0,3}郵件|發郵件|开启相机|拍照|螢幕|屏幕|滑一下|關閉|关闭|盯著|盯着|頂著|顶着|盯住|幫我盯|帮我盯|守望|監看|监看|記帳|记账|花了|花費|花费|支出|看著.{0,10}(叫|提醒|通知)|看着.{0,10}(叫|提醒|通知))/u', $userMessage)) {
            return 'skill';
        }
