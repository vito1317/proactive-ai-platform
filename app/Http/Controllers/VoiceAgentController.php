...
class VoiceAgentController extends Controller
{
    ...
    {
        return (bool) preg_match('/(比價|比价|研究|調查|调查|分析|彙整|汇整|整理出|規劃|规划|行程|攻略|最便宜|最划算|哪間|哪家|住宿|機票|机票|飯店|饭店|報告|报告|訂票|订票|訂機票|订机票|訂房|订房|訂位|订位|訂飯店|预订|預訂|訂購|订购|購買|购买|報名|报名|掛號|挂号|租車|租车)/u', $t);
    }
